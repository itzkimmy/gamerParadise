...
include 'components/wishlistCart.php';
...
<section class="category">
   ...
   <a href="category.php?category=memory" class="swiper-slide slide">
      <img src="image/icon-5.png" alt="">
      <h3>memory&storage</h3>
   </a>

   <a href="category.php?category=peripheral" class="swiper-slide slide">
   ...
   <a href="category.php?category=printer" class="swiper-slide slide">
...
<section class="home-products">
   ...
   <form action="" method="post" class="swiper-slide slide">
      ...
      <img src="product_image/<?= $fetch_product['image_01']; ?>" alt="">
